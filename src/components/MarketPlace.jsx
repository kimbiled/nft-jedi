        ...
        (  <div className="p-10 space-y-6 bg-[#0A1330] h-full  fonts-mono">
          ...
          <div data-aos="fade-right" className="flex flex-row items-center justify-between">
            ...
            <div className="flex flex-row gap-4">
              {/* NFT Card */}
              <div data-aos="fade-right" className="flex flex-col gap-4 p-4 text-[#AEB9E1] w-1/6">
                  {/* Первый блок */}
          ...
          {["All", "Buy Now", "Live"].map((stat) => (
              ...
              <div data-aos="fade-left" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-[#AEB9E1] w-[65%]">
          {nfts.map((nft) => (
              <div
                  key={nft.id}
