...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-[#0A1330] text-[#AEB9E1] flex flex-col border border-[#343B4F] h-full w-[300px]">
      {/* Return to site */}
      ...
      {/* User Info */}
      <div className="p-4 flex items-center gap-[85px]">
      ...
      <nav className="flex-1 p-4 space-y-4">
        ...
        onClick={goToMyTokens}>
            <div className="flex items-center space-x-2">
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="fill-current text-[#AEB9E1] group-hover:fill-[#CB3CFF]"
                >
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            <div>
                    ...
                    <div className="ml-6 mt-2 space-y-2">
                            <a
                                href="#"
                                className="block text-sm text-white relative w-[225px] h-[40px] bg-[#081028] border border-[#081028] rounded-md">
                                <span
      ...
      {/* Settings */}
      <div className="p-4 border-t border-[#1A233A] mb-12">
      <div className="group flex items-center justify-between hover:text-[#CB3CFF]  h-[40px]">
            <div className="flex items-center space-x-2">
                {/* SVG Иконка */}
                <svg
